...
class _homepageState extends State<homepage> {
  ...
  Row _buildJournalFooterImages() {
    return Row(
      ...
      children: <Widget>[
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/1181293.png'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/watanabe.jpg'),
          radius: 40.0,
        ),
        CircleAvatar(
          backgroundImage: AssetImage('assets/images/1180525.jpg'),
          radius: 40.0,
        ),
        SizedBox(
          width: 100.0,
